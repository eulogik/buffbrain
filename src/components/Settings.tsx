...
export const Settings = ({ onClose }: Props) => {
  ...
  const save = async () => {
    ...
    try {
      ...
      await api.setConfig(theme, aiEnabled, showTray, autoStart);
    ...
    <div className="settings">
      ...
      <div className="settings-body">
        ...
        <div className="settings-section">
          <div className="settings-row">
            <div>
              <div className="settings-label">Show Tray Icon</div>
              <div className="settings-sublabel">Show Buffalo icon in menu bar</div>
            </div>
            <label className="switch">
              <input
                type="checkbox"
        ...
        <div className="settings-section">
          <div className="settings-row">
            <div>
              ...
              <div className="settings-sublabel">Auto-start BuffBrain when you log in</div>
            </div>
            <label className="switch">
              <input
                type="checkbox"
